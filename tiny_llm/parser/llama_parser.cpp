...
auto llama_add_node(
  ...
  TINY_LLM_CHECK(InvalidArgumentError, output_num<T>() == 1);
...
auto llama_add_node(Graph &g, const std::string &node_name,
  ...
  TINY_LLM_CHECK(InvalidArgumentError, output_num<EmbeddingParam>() == 1);
...
auto llama_add_node(Graph &g, const std::string &node_name,
  ...
  TINY_LLM_CHECK(InvalidArgumentError, output_num<RopeParam>() == 2);
...
auto llama_add_node(Graph &g, const std::string &node_name,
  ...
  TINY_LLM_CHECK(InvalidArgumentError, output_num<RMSNormParam>() == 1);
...
auto llama_add_node(Graph &g, const std::string &node_name,
  ...
  TINY_LLM_CHECK(InvalidArgumentError, param.bias == false);
  TINY_LLM_CHECK(InvalidArgumentError, output_num<LinearParam>() == 1);
...
auto llama_add_node(Graph &g, const std::string &node_name,
  ...
  TINY_LLM_CHECK(InvalidArgumentError, param.bias == false);
  TINY_LLM_CHECK(InvalidArgumentError, output_num<CausalAttentionParam>() == 1);
...
auto llama_add_node(Graph &g, const std::string &node_name,
  ...
  TINY_LLM_CHECK(InvalidArgumentError, param.bias == false);
  TINY_LLM_CHECK(InvalidArgumentError, output_num<SliceLinearParam>() == 1);
